# -*- coding: utf-8 -*-
"""
Created on Fri Aug 13 13:39:27 2021
...
embed = t_hub.KerasLayer('/Users/ksanto20/work/embeddings/universal-sentence-encoder_4')
...
def get_details():
    logger.debug('started scrapping... ')
    data = request.json
    url= data['url']
...
#print(get_details('https://www.uhcglobalclinicaljournal.com'))
